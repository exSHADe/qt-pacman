...
{
    return QRect(gx-15,gy-15,20,20);
}
...
//    painter->setOpacity(0.3);
    if(!scare){
        switch(direction){
            case 1:
                if(animestate==0){
                    painter->drawPixmap(gx-15,gy-15,30,30,left1);
                }else{
                    painter->drawPixmap(gx-15,gy-15,30,30,left2);
                }
                break;
            case 4:
                if(animestate==0){
                    painter->drawPixmap(gx-15,gy-15,30,30,right1);
                }else{
                    painter->drawPixmap(gx-15,gy-15,30,30,right2);
                }
                break;
            case 3:
                if(animestate==0){
                    painter->drawPixmap(gx-15,gy-15,30,30,down1);
                }else{
                    painter->drawPixmap(gx-15,gy-15,30,30,down2);
                }
                break;
            case 2:
                if(animestate==0){
                    painter->drawPixmap(gx-15,gy-15,30,30,up1);
                }else{
                    painter->drawPixmap(gx-15,gy-15,30,30,up2);
                }
                break;
        }
    }else{
        if(whiteb){
            if(animestate==0){
                painter->drawPixmap(gx-15,gy-15,30,30,scareb);
            }else{
                painter->drawPixmap(gx-15,gy-15,30,30,scarew1);
            }
        }else{
            if(animestate==0){
                painter->drawPixmap(gx-15,gy-15,30,30,scareb);
            }else{
                painter->drawPixmap(gx-15,gy-15,30,30,scareb1);
            }
        }
